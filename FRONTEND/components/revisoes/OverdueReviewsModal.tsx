    ...
    <>
      ...
      <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
        <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-2xl dark:shadow-dark-2xl 
          ...
          {/* Header */}
          <div className="p-6 border-b-2 border-border-light dark:border-border-dark">
                    ...
                    {selectedOption === 'reschedule' && (
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 rounded-lg border-2 border-border-light dark:border-border-dark
          ...
          {/* Footer */}
          <div className="p-6 border-t-2 border-border-light dark:border-border-dark flex justify-end gap-3">
            <button
              onClick={onClose}
              disabled={loading}
