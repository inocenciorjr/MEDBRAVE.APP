...
export class MedbraveAIService {
  private static instance: MedbraveAIService;
  private baseUrl = '/api/medbrave-ai';

  public static getInstance(): MedbraveAIService {
    if (!MedbraveAIService.instance) {
      MedbraveAIService.instance = new MedbraveAIService();
    }
    return MedbraveAIService.instance;
  }
...
export const medbraveAIService = MedbraveAIService.getInstance(); 