...
import { GameBoard } from '@/components/playground/med-termooo/GameBoard';
import { HowToPlayModal } from '@/components/playground/med-termooo/HowToPlayModal';
import { DailyWord } from '@/components/playground/med-termooo/types';
        ...
        <header className="bg-surface-light dark:bg-surface-dark border-b border-border-light dark:border-border-dark px-3 sm:px-4 py-2 flex-shrink-0">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <Link
                href="/playground/med-termooo/ranking"
                className="p-1.5 rounded-lg hover:bg-primary/10 transition-colors"
              >
