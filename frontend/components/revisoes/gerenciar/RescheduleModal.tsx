  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-3 sm:p-4">
      <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-2xl dark:shadow-dark-2xl 
                      border-2 border-border-light dark:border-border-dark w-full max-w-[95vw] sm:max-w-md
        ...
        <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    <p className="font-medium text-sm sm:text-base text-text-light-primary dark:text-text-dark-primary">
                      Data Específica
                    </p>
          ...
          {mode === 'specific' && (
            <div>
              <label className="block text-xs sm:text-sm font-medium text-text-light-primary dark:text-text-dark-primary mb-1.5 sm:mb-2">
                Nova Data
              </label>
              <input
                type="date"
                ...
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg border-2 border-border-light dark:border-border-dark
                           bg-surface-light dark:bg-surface-dark
                           text-sm sm:text-base text-text-light-primary dark:text-text-dark-primary
                           focus:border-primary focus:ring-4 focus:ring-primary/20
                           transition-all duration-200"
              />
              <p className="text-[10px] sm:text-xs text-text-light-secondary dark:text-text-dark-secondary mt-1.5 sm:mt-2">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg border-2 border-border-light dark:border-border-dark
                             ...
                             transition-all duration-200"
                />
                <div className="mt-2 sm:mt-3 p-2.5 sm:p-3 bg-primary/5 dark:bg-primary/10 rounded-lg border border-primary/20">
                  <p className="text-[10px] sm:text-xs font-medium text-text-light-primary dark:text-text-dark-primary mb-1.5 sm:mb-2">
                    🎯 Distribuição Inteligente
                  </p>
                  <ul className="text-[10px] sm:text-xs text-text-light-secondary dark:text-text-dark-secondary space-y-0.5 sm:space-y-1">
                    <li>• ~{Math.ceil(selectedReviews.length / distributeDays)} revisões por dia</li>
                    <li>• <strong className="text-red-500">Prioridade 1:</strong> Cards que você errou</li>
        ...
        {/* Footer */}
        <div className="p-4 sm:p-6 border-t border-border-light dark:border-border-dark flex gap-2 sm:gap-3">
          <button
            onClick={onClose}
            disabled={loading}
            className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg border-2 border-border-light dark:border-border-dark
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg bg-primary text-white
                       hover:bg-primary/90 transition-colors font-medium text-sm sm:text-base
