...
export default function CollectionMenu({ onOpen, onEdit, onDelete }: CollectionMenuProps) {
        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              <span className="flex-1">Abrir Coleção</span>
            ...
            >
              ...
              <span className="flex-1">Editar Coleção</span>
              <svg className="w-4 h-4 opacity-0 group-hover/item:opacity-100 transition-opacity duration-150 flex-shrink-0"
                   fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            ...
            >
              ...
              <span className="flex-1">Remover Coleção</span>
              <svg className="w-4 h-4 opacity-0 group-hover/item:opacity-100 transition-opacity duration-150 flex-shrink-0"
                   fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
