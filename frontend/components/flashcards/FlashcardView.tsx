      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)]">
          <div className="w-full max-w-5xl mx-auto flex flex-col gap-12">
            {/* Header */}
            <header className="w-full flex justify-between items-center px-2 py-4 rounded-xl bg-surface-light/50 dark:bg-surface-dark/50 backdrop-blur-sm border border-border-light/30 dark:border-border-dark/30">
              <button
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="bg-surface-light dark:bg-surface-dark border-2 border-border-light dark:border-border-dark 
                           ...
                           rounded-lg w-10 h-10 flex items-center justify-center shadow-md
                           active:scale-95"
                ...
                <span className="text-sm font-semibold text-text-light-primary dark:text-text-dark-primary min-w-[80px] text-center bg-surface-light dark:bg-surface-dark px-4 py-2 rounded-lg border border-border-light dark:border-border-dark shadow-sm">
            ...
            {isCurrentCardAnswered && (
              <div className="max-w-4xl mx-auto px-4 mb-4">
                <div className="bg-yellow-100 dark:bg-yellow-900/30 border-2 border-yellow-400 dark:border-yellow-600 rounded-lg px-4 py-3 flex items-center gap-3 shadow-md">
                  <span className="material-symbols-outlined text-yellow-600 dark:text-yellow-400 text-2xl">check_circle</span>
