...
export interface PulseAuditLog {
  ...
  userId: string;
  userRole?: string;
  action: 'medical_analysis' | 'medical_education' | 'quick_query' | 'content_moderation' | 'question_explanation' | 'question_extraction' | 'question_categorization';
  input: {
    query?: string;
    topic?: string;
    specialty?: string;
...
export interface PulseWebhookEvent {
  id: string;
  type: 'analysis_completed' | 'education_requested' | 'moderation_flagged' | 'error_occurred';
  timestamp: string;
  userId: string;
  data: any;
  retry?: number;
...
export type PulseActionType = 'medical_analysis' | 'medical_education' | 'quick_query' | 'content_moderation' | 'question_explanation' | 'question_extraction' | 'question_categorization';
