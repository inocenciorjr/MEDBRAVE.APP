...
export interface IAchievementService {
   ...
   */
  createAchievement(
    achievement: Omit<Achievement, 'id' | 'createdAt' | 'updatedAt' | 'version'>,
  ): Promise<Achievement>;
   ...
   */
  createAchievementsFromTemplate(
   ...
   */
  getPendingRewards(userId: string): Promise<
    Array<{
      achievementId: string;
   ...
   */
  generateAchievementSuggestions(userId: string): Promise<
    Array<{
      achievementId: string;
      achievement: Achievement;
      probability: number;
